  ...
  play: async ({ canvasElement, step }) => {
    ...
    await step(
      ...
      async () => {
        ...
        await waitFor(() =>
          expect(
            canvas.getByText("The xbox Switch's disabled is changed to true")
          ).toBeInTheDocument()
        );
      }
    );

    await step('Click "Switch" label. Then it is also checked', async () => {
    ...
    await step(
      ...
      async () => {
        ...
        await waitFor(() =>
          expect(
            canvas.getByText("The xbox Switch's disabled is changed to false")
          ).toBeInTheDocument()
        );
      }
    );
