...
const Test = () => {
    ...
    return (
        <>
            ...
            <Button data-testid="showFormDataBtu" onClick={handleShowFormDataBtuClick}>Show Form Data</Button>
            <Button data-testid="setFormDataBtu" onClick={handleSetFruitBtuClick}>Set Fruit Apple</Button>
...
export const RadioWithFormTest: RadioStory = {
    ...
    play: async ({ canvasElement, step }) => {
        ...
        await step('Set "Fruit" radioGroup defaultValue is "banana", click "Show Form Data" button, then "Banana" radio is checked, other radios are unchecked, formData.fruit is banana', async () => {
            await expect(
        ...
        await step('Click "Set Fruit Apple" button, click "Show Form Data" button, then "Apple" radio is checked, other radios are unchecked, formData.fruit is apple', async () => {
