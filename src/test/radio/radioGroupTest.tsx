...
const Test = () => {
    ...
    return (
        <>
            ...
            <Button data-testid="appleBtu" onClick={handleCheckAppleBtuClick}>Check Apple</Button>
            <Button data-testid="bananaBtu" onClick={handleCheckBananaBtuClick}>Check Banana</Button>
            <Button data-testid="peachBtu" onClick={handleCheckPeachBtuClick}>Check Peach</Button>
...
export const RadioGroupTest: RadioStory = {
    ...
    play: async ({ canvasElement, step }) => {
        ...
        await step(' Set "Fruit" radioGroup defaultValue is "banana", then "Banana" radio is checked, other radios are unchecked', async () => {
            await expect(
        ...
        await step('Click "Check Apple" button", then "Apple" radio is checked, other radios are unchecked', async () => {
        ...
        await step('Click "Check Peach" button", then "Peach" radio is checked, other radios are unchecked', async () => {
        ...
        await step('Click "Apple" radio, then "Fruit" radioGroup value is "apple"', async () => {
