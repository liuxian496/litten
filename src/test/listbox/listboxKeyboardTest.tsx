...
const Test = () => {
  ...
  const [selectedValue, setSelectedValue] = useState<string | undefined>('b');
  ...
  return (
    <>
      ...
      <Button onClick={handleJDisabledButtonClick}>Toggle Disabled</Button>
...
export const ListboxKeyboardTest: ListboxStory = {
  ...
  play: async ({ canvasElement, step }) => {
    ...
    await step('Click Tab.Then "listbox" to have focus.', async () => {
      ...
      const selectedItem = await canvas.findByText('b');
