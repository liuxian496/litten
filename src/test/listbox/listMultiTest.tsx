...
export const MultiTest: ButtonStory = {
  ...
  play: async ({ canvasElement, step }) => {
    ...
    await step('Click Tab.Then "listbox" to have focus.', async () => {
      ...
      const selectedItem = await canvas.findByText('a');
    ...
    await step(
      'Click {ArrowDown}{ArrowDown}{Spacebar} with keyboard.Then "SelectedValue is a,d" to be in the document.',
      async () => {
    ...
    await step(
      'Click "h" listItem with keyboard.Then "SelectedValue is a,d,h" to be in the document.',
      async () => {
    ...
    await step(
      'Click {ArrowUp}{Spacebar} with keyboard.Then "SelectedValue is a,d,h,g" to be in the document.',
      async () => {
    ...
    await step(
      'Click "d" listItem with keyboard.Then "SelectedValue is a,h,g" to be in the document.',
      async () => {
    ...
    await step(
      'Click {ArrowUp}{ArrowUp}{Spacebar} with keyboard.Then "SelectedValue is a,d,h,g" to be in the document.',
      async () => {
