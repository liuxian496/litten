  ...
  play: async ({ canvasElement, step }) => {
    ...
    await step(
      ...
      async () => {
        ...
        await waitFor(() => expect(canvas.getByTestId('xbox')).toBeDisabled());
    ...
    await step('Click "Switch" label, it is also checked', async () => {
      ...
      await waitFor(() => expect(canvas.getByTestId('switch')).toBeChecked());
    });
    ...
    await step(
      ...
      async () => {
        ...
        await waitFor(() => expect(canvas.getByTestId('switch')).toBeEnabled());

        await waitFor(() => expect(canvas.getByTestId('xbox')).toBeEnabled());
